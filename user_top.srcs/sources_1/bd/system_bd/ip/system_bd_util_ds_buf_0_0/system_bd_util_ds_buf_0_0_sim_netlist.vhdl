...
--               f:/ziliao/ku60/user_top/user_top/user_top.srcs/sources_1/bd/system_bd/ip/system_bd_util_ds_buf_0_0/system_bd_util_ds_buf_0_0_sim_netlist.vhdl
...
entity system_bd_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of system_bd_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of system_bd_util_ds_buf_0_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of system_bd_util_ds_buf_0_0_util_ds_buf : entity is "ibufdsgte3";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of system_bd_util_ds_buf_0_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of system_bd_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_bd_util_ds_buf_0_0_util_ds_buf : entity is "util_ds_buf";
end system_bd_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of system_bd_util_ds_buf_0_0_util_ds_buf is
...
entity system_bd_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of system_bd_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_bd_util_ds_buf_0_0 : entity is "system_bd_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_bd_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_bd_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2019.2";
end system_bd_util_ds_buf_0_0;

architecture STRUCTURE of system_bd_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_bd_util_ds_buf_0_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_bd_util_ds_buf_0_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.system_bd_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
